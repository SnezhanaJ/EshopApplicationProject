...
namespace Eshop.Repository.Migrations
{
    ...
    [Migration("20240407134539_OnionMigrationTwo")]
    partial class OnionMigrationTwo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eshop.Domain.Domain.Order", b =>
                {
                    b.HasOne("Eshop.Domain.Identity.EShopApplicationUser", "OrderOwner")
                        .WithMany()
            ...
            modelBuilder.Entity("Eshop.Domain.Domain.ProductInOrder", b =>
                {
                    b.HasOne("Eshop.Domain.Domain.Order", "UserOrder")
                        .WithMany("ProductInOrder")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Eshop.Domain.Domain.Product", "SelectedProduct")
                        .WithMany("Orders")
